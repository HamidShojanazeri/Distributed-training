...
def fsdp_main(args):
    ...
    train_dataset = wikihow(tokenizer, 'train', 1000, 512, 150)
    val_dataset = wikihow(tokenizer, 'validation', 500, 512, 150)
    ...
    if args.activation_checkpointing:
        model.gradient_checkpointing_enable() # uses HF API
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.save_model and curr_val_loss < best_val_loss:
            ...
            if rank == 0:
                torch.save(cpu_state, "T5_checkpoint.pt")
    ...
    if rank == 0:
            ...
            # memory summary
            if args.memory_report and rank == 0:
                print(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--memory_report', action='store_false', default=True,
                        help='report memory summary usage')
    parser.add_argument('--activation_checkpointing', action='store_false', default=True,
